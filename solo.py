...
class MyGUI:
    ...
    def books_window(self):
        ...
        self.genre_label = tkinter.Label(root, text = "Genre(s): ")
        self.genre_label.place(x=20, y=10)
        ...
        self.cb1 = tkinter.Checkbutton(root,
            text = 'Read',
            variable = self.cb_var1)
        self.cb2 = tkinter.Checkbutton(root,
            text = 'Unread',
            variable = self.cb_var2)
        self.cb3 = tkinter.Checkbutton(root,
            text = 'All Books',
            variable = self.cb_var3)
    
        self.cb1.place(x=20, y=30)
        self.cb2.place(x=20, y=50)
        self.cb3.place(x=20, y=70)
